...
export const posts = [
  {
    ...
    "updated": "2025-08-25T00:00:00.000Z",
    "raw": "\nWelcome to my blog! This post shows **Markdown** features.\n## Code block\n\n~~~typescript\nfunction greet(name: string) {\n  return `Hello, ${name}!`;\n}\nconsole.log(greet('world'));\n~~~\nInline code like `const x = 42` adapts to theme.",
    "excerpt": "Welcome to my blog! This post shows **Markdown** features. #…"
  },
  {
    "slug": "tutorials-react-vite-setup",
    ...
    "updated": "2025-09-07T12:16:01.554Z",
